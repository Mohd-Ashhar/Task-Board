...
function LoginForm() {
  const [state, action, isPending] = useActionState(login, { message: "", error: {} });
  const searchParams = useSearchParams();
  void searchParams; // available for future callbackUrl logic
    ...
    <Suspense
      fallback={
        <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6">
          <div className="h-5 w-32 rounded-md animate-shimmer mb-2" />
